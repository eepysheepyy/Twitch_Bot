...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/domhutchinson/.local/share/virtualenvs/domhutchinson-aSVk77oJ'
    let bin = 'bin'
    let path_sep = ':'
    ...
    let virtual_prompt = if ('domhutchinson' == '') {
...
alias deactivate = source '/Users/domhutchinson/.local/share/virtualenvs/domhutchinson-aSVk77oJ/bin/deactivate.nu'
